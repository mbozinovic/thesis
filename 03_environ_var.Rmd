...
```{r}
env07 <- readRDS(file = "data/GPSwhaleAIS7.rda")
env08 <- readRDS(file = "data/GPSwhaleAIS8.rda")
env10 <- readRDS(file = "data/GPSwhaleAIS10.rda")
env12 <- readRDS(file = "data/GPSwhaleAIS12.rda")
env13 <- readRDS(file = "data/GPSwhaleAIS13.rda")
env14 <- readRDS(file = "data/GPSwhaleAIS14.rda")
env16 <- readRDS(file = "data/GPSwhaleAIS16.rda")
env18 <- readRDS(file = "data/GPSwhaleAIS18.rda")
env19 <- readRDS(file = "data/GPSwhaleAIS19.rda")
env20 <- readRDS(file = "data/GPSwhaleAIS20.rda")
env21 <- readRDS(file = "data/GPSwhaleAIS21.rda")
env22 <- readRDS(file = "data/GPSwhaleAIS22.rda")
env23 <- readRDS(file = "data/GPSwhaleAIS23.rda")
```
...
#env07 <- matchEnvData(GPSwhaleAIS7, nc = 'jplMURSST41', fileName = "D:/Environ_variables/analysedSST07", var = c('analysed_sst'))
#env08 <- matchEnvData(GPSwhaleAIS8, nc = 'jplMURSST41', fileName = "D:/Environ_variables/analysedSST08", var = c('analysed_sst'))
#env10 <- matchEnvData(GPSwhaleAIS10, nc = 'jplMURSST41', fileName = "D:/Environ_variables/analysedSST10", var = c('analysed_sst'))
#env12 <- matchEnvData(GPSwhaleAIS12, nc = 'jplMURSST41', fileName = "D:/Environ_variables/analysedSST12", var = c('analysed_sst'))
#env13 <- matchEnvData(GPSwhaleAIS13, nc = 'jplMURSST41', fileName = "D:/Environ_variables/analysedSST13", var = c('analysed_sst'))
#env14 <- matchEnvData(GPSwhaleAIS14, nc = 'jplMURSST41', fileName = "D:/Environ_variables/analysedSST14", var = c('analysed_sst'))
#env16 <- matchEnvData(GPSwhaleAIS16, nc = 'jplMURSST41', fileName = "D:/Environ_variables/analysedSST16", var = c('analysed_sst'))
#env18 <- matchEnvData(GPSwhaleAIS18, nc = 'jplMURSST41', fileName = "D:/Environ_variables/analysedSST18", var = c('analysed_sst'))
#env19 <- matchEnvData(GPSwhaleAIS19, nc = 'jplMURSST41', fileName = "D:/Environ_variables/analysedSST19", var = c('analysed_sst'))
#env20 <- matchEnvData(GPSwhaleAIS20, nc = 'jplMURSST41', fileName = "D:/Environ_variables/analysedSST20", var = c('analysed_sst'))
#env21 <- matchEnvData(GPSwhaleAIS21, nc = 'jplMURSST41', fileName = "D:/Environ_variables/analysedSST21", var = c('analysed_sst'))
#env22 <- matchEnvData(GPSwhaleAIS22, nc = 'jplMURSST41', fileName = "D:/Environ_variables/analysedSST22", var = c('analysed_sst'))
#env23 <- matchEnvData(GPSwhaleAIS23, nc = 'jplMURSST41', fileName = "D:/Environ_variables/analysedSST23", var = c('analysed_sst'))
```
...
```{r}
# Downloads data from servers onto external hard drive. Uncomment and only run once.
#env07 <- matchEnvData(env07, nc = 'erdQAstress1day', fileName = "D:/Environ_variables/windstress07.nc", var = c('curl'))
#env08 <- matchEnvData(env08, nc = 'erdQAstress1day', fileName = "D:/Environ_variables/windstress08.nc", var = c('curl'))
#env10 <- matchEnvData(env10, nc = 'erdQAstress1day', fileName = "D:/Environ_variables/windstress10.nc", var = c('curl'))
#env12 <- matchEnvData(env12, nc = 'erdQAstress1day', fileName = "D:/Environ_variables/windstress12.nc", var = c('curl'))
#env13 <- matchEnvData(env13, nc = 'erdQAstress1day', fileName = "D:/Environ_variables/windstress13.nc", var = c('curl'))
#env14 <- matchEnvData(env14, nc = 'erdQAstress1day', fileName = "D:/Environ_variables/windstress14.nc", var = c('curl'))
#env16 <- matchEnvData(env16, nc = 'erdQAstress1day', fileName = "D:/Environ_variables/windstress16.nc", var = c('curl'))
#env18 <- matchEnvData(env18, nc = 'erdQAstress1day', fileName = "D:/Environ_variables/windstress18.nc", var = c('curl'))
#env19 <- matchEnvData(env19, nc = 'erdQAstress1day', fileName = "D:/Environ_variables/windstress19.nc", var = c('curl'))
#env20 <- matchEnvData(env20, nc = 'erdQAstress1day', fileName = "D:/Environ_variables/windstress20.nc", var = c('curl'))
#env21 <- matchEnvData(env21, nc = 'erdQAstress1day', fileName = "D:/Environ_variables/windstress21.nc", var = c('curl'))
#env22 <- matchEnvData(env22, nc = 'erdQAstress1day', fileName = "D:/Environ_variables/windstress22.nc", var = c('curl'))
#env23 <- matchEnvData(env23, nc = 'erdQAstress1day', fileName = "D:/Environ_variables/windstress23.nc", var = c('curl'))
```
...
for (t in tracklist) {
  Hdata <- matchEnvData(as.data.frame(get(paste0("env", substr(t, 4, 5)))), nc=PAMmisc::hycomList, var=c('water_temp', 'salinity'), raw=TRUE, depth = 0:1000)
