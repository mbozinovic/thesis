...
W.20plot <- plotPresGrid(W.20, bin = 'hour', type = 'presence', start = min(GPSwhaleAISenvSS20$UTC),
                         end = max(GPSwhaleAISenvSS20$UTC),  by = 'Wpresence', alpha = 0.5)

plotTimeseries(GPSwhaleAISenvSS20, column='TOL_2000', bin='1hour', style = 'heatmap', title='Buoy 20: TOL 2000 Plot') +  W.20plot
plotTimeseries(GPSwhaleAISenvSS20, column='TOL_125', bin='1hour', style = 'heatmap', title='Buoy 20: TOL 125 Plot') +  W.20plot
...
print(paste("BWC Max TOL20000 sound level: ", max(BWC$TOL_2000, na.rm = TRUE)))
print(paste("BWC Min TOL20000 sound level: ", min(BWC$TOL_2000, na.rm = TRUE)))
...
print(paste("BW37V Max TOL20000 sound level: ", max(BW37V$TOL_2000, na.rm = TRUE)))
print(paste("BW37V Min TOL20000 sound level: ", min(BW37V$TOL_2000, na.rm = TRUE)))
