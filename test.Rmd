...
## Read in AIS Data
```{r}
rawAIS<- read_csv("Data/AIS_072518_072918.csv")
# need to figure out where to store data
```
...
# Plot
p <- bplot + 
  geom_path(data = track_BB_OL_10, 
            aes(x=long,y=lat,group=spotID), 
            alpha = 0.5,
            linewidth = 3) + # line width parameter is ignored for some reason
  geom_point(data = track_BB_OL_10, 
